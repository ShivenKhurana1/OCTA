export default {
  ...
  // Tutorial
  SHOW_TUTORIAL: true,
  TUTORIAL_FADE_MS: 400,
  TUTORIAL_MUSIC_KEY: 'octave_demo',
  TUTORIAL_TEXT: {
    header: 'Welcome to Octa',
    part1: 'An octave is a series of eight notes. In western music the distance from one C to the next C is an octave.',
    part2: 'In this game each wall hit plays a note. When you hear all eight notes you have completed an octave!',
    part3: 'Press SPACEBAR to shoot. Hover the mouse to aim the direction toward the centre.'
  },
